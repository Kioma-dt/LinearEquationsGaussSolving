...
std::vector<double> solveGauss(std::vector<std::vector<double>> A, std::vector<double> b)
{
    ...
    if (A[A.size() - 1][A.size() - 1] == 0){
        if (b[b.size() - 1] == 0){
            throw new std::runtime_error("Infinite number of solutions");
        }
        else {
            throw new std::runtime_error("No solutions");
        }
    }
...
std::vector<double> checkSolution(std::vector<std::vector<double>> A, std::vector<double> x){
    std::vector<double> b;
